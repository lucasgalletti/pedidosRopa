...
<head>
 ...
 //   $sector_login = $_SESSION['sector'];
    ...
    $usuarios="select * from usuarios as a
                left join sector as b on a.id_sector = b.id_sector
                where 	a.display = 'si' 
		and a.id_sector = (select c.id_sector from usuarios as c
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card text-left">
                    ...
                    <div class="card-body">
<!--                    <button type="button" class="btn btn-secondary" disabled>Si faltó cargar avisar a RRHH</button>      -->
                        ...
                        <span class="fas fa-plus-square"></span>
                           ...
                           <div style="float: right;">
                                   <label>Sector: </label>
                                    ...
                                    ?>
                                    <button type="button" class="btn btn-secondary" disabled><?php echo $sect[11];?></button>
                                    <?php
                                        }
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
			...
			<form id="alta">
                ...
                <div id="cantidad" class="form-group row" style="margin-top: 5px; margin-left: 2px;">
                </div>
